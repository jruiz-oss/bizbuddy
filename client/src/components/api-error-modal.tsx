...
export function ApiErrorModal() {
  ...
  // Reconnecting Google re-runs OAuth for the SHARED agency connection, which
  // the whole team has the login for — anyone can complete it, so this isn't
  // gated by local-user role.
